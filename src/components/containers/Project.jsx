  ...
  return (
    <div className="project-card">
      ...
      <h2>
        ...
        {project.images
          ? /*<img src={project.images[0]} alt={project.name} />*/ <RenderSmoothImage src={project.images[0]} alt={project.name} />
        : null}
        <div className="tags">
          {project.tags
      ...
      <div className="back">
        ...
        <Carousel>
          ...
          />*/}
          <RenderSmoothImage src={img} alt={`${project.name} slide${index}`} />
        </Carousel.Item>)
          : null}
          </Carousel> : (project.images.length === 1 ? /*<img src={project.images[0]} alt={project.name}></img>*/
